...
public class scoreScreen extends javax.swing.JFrame {
    ...
    public scoreScreen() {
        ...
        Color mediumColor = new Color(255,197, 140);
        ...
        if(getQuestionNumber() >= 7){
            Question6.setBackground(mediumColor);
        }
        if(getQuestionNumber() >= 8){
            Question7.setBackground(mediumColor);
        }
    ...
    private void nextBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextBtnActionPerformed
        this.dispose();
        QuestionScreen QuestionWindow = new QuestionScreen();
